 ...
 * yet (rare), it retries a few times on a short interval; if it still isn't ready it shows a
...
class PostReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (retry < MAX_RETRY) {
            NotificationHelper.showBrief(context, id, "TellMe", "Preparing your brief… it will appear shortly.")
